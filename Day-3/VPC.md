“A VPC (Virtual Private Cloud) is a private network inside AWS where we can launch resources like EC2, RDS, and Load Balancers. 
In a VPC, we control the IP range, subnets, route tables, and security, so our cloud infrastructure stays isolated and secure.”
